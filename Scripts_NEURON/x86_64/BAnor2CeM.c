...
#define DA1 DA1_banor2CeM
#define eta eta_banor2CeM
#define omega omega_banor2CeM
#define sfunc sfunc_banor2CeM
#define unirand unirand_banor2CeM
...
#define Beta2 Beta2_banor2CeM
 double Beta2 = 0.0001;
#define Beta1 Beta1_banor2CeM
 double Beta1 = 0.001;
#define DA_t2 DA_t2_banor2CeM
 double DA_t2 = 1.4;
#define DA_t1 DA_t1_banor2CeM
 double DA_t1 = 1.2;
#define DAstop1 DAstop1_banor2CeM
 double DAstop1 = 420000;
#define DAstart1 DAstart1_banor2CeM
 double DAstart1 = 400000;
#define GAPstop1 GAPstop1_banor2CeM
 double GAPstop1 = 720000;
#define GAPstart1 GAPstart1_banor2CeM
 ...
 "DAstart1_banor2CeM", &DAstart1_banor2CeM,
 "DAstop1_banor2CeM", &DAstop1_banor2CeM,
 "DA_t1_banor2CeM", &DA_t1_banor2CeM,
 "DA_t2_banor2CeM", &DA_t2_banor2CeM,
 "Beta1_banor2CeM", &Beta1_banor2CeM,
 "Beta2_banor2CeM", &Beta2_banor2CeM,
 "GAPstart1_banor2CeM", &GAPstart1_banor2CeM,
 "GAPstop1_banor2CeM", &GAPstop1_banor2CeM,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 banor2CeM /pylon5/ib560mp/latimerb/CE_Model/Scripts_NEURON/x86_64/BAnor2CeM.mod\n");
 ...
 v=_v;
{
 ...
 for (; t < _break; t += dt) {
 error =  release();
 if(error){fprintf(stderr,"at line 163 in file BAnor2CeM.mod:\n	\n"); nrn_complain(_p); abort_run(error);}
