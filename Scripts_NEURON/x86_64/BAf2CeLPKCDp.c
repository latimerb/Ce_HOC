...
#define nrn_init _nrn_init__baf2CeLPKCDp
#define _nrn_initial _nrn_initial__baf2CeLPKCDp
#define nrn_cur _nrn_cur__baf2CeLPKCDp
#define _nrn_current _nrn_current__baf2CeLPKCDp
#define nrn_jacob _nrn_jacob__baf2CeLPKCDp
#define nrn_state _nrn_state__baf2CeLPKCDp
#define _net_receive _net_receive__baf2CeLPKCDp 
#define release release__baf2CeLPKCDp 
...
#define DA1 DA1_baf2CeLPKCDp
#define eta eta_baf2CeLPKCDp
#define omega omega_baf2CeLPKCDp
#define sfunc sfunc_baf2CeLPKCDp
#define unirand unirand_baf2CeLPKCDp
...
#define Beta2 Beta2_baf2CeLPKCDp
 double Beta2 = 0.0001;
#define Beta1 Beta1_baf2CeLPKCDp
 double Beta1 = 0.001;
#define DA_t2 DA_t2_baf2CeLPKCDp
 double DA_t2 = 1.4;
#define DA_t1 DA_t1_baf2CeLPKCDp
 double DA_t1 = 1.2;
#define DAstop1 DAstop1_baf2CeLPKCDp
 double DAstop1 = 420000;
#define DAstart1 DAstart1_baf2CeLPKCDp
 double DAstart1 = 400000;
#define GAPstop1 GAPstop1_baf2CeLPKCDp
 double GAPstop1 = 720000;
#define GAPstart1 GAPstart1_baf2CeLPKCDp
 ...
 "Beta1_baf2CeLPKCDp", "/ms",
 "Beta2_baf2CeLPKCDp", "/ms",
 "srcid", "1",
 "destid", "1",
 "Cdur_nmda", "ms",
 "AlphaTmax_nmda", "/ms",
 ...
 "DAstart1_baf2CeLPKCDp", &DAstart1_baf2CeLPKCDp,
 "DAstop1_baf2CeLPKCDp", &DAstop1_baf2CeLPKCDp,
 "DA_t1_baf2CeLPKCDp", &DA_t1_baf2CeLPKCDp,
 "DA_t2_baf2CeLPKCDp", &DA_t2_baf2CeLPKCDp,
 "Beta1_baf2CeLPKCDp", &Beta1_baf2CeLPKCDp,
 "Beta2_baf2CeLPKCDp", &Beta2_baf2CeLPKCDp,
 "GAPstart1_baf2CeLPKCDp", &GAPstart1_baf2CeLPKCDp,
 "GAPstop1_baf2CeLPKCDp", &GAPstop1_baf2CeLPKCDp,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 baf2CeLPKCDp /work/05300/latimerb/stampede2/CE_Model/Scripts_NEURON/x86_64/BAf2CeLPKCDp.mod\n");
 ...
 v=_v;
{
  eca = _ion_eca;
 { error =  release();
 if(error){fprintf(stderr,"at line 163 in file BAf2CeLPKCDp.mod:\n	\n"); nrn_complain(_p); abort_run(error);}
 }}}
