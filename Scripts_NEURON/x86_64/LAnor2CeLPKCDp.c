...
#define DA1 DA1_lanor2CeLPKCDp
#define GAP1 GAP1_lanor2CeLPKCDp
#define eta eta_lanor2CeLPKCDp
#define omega omega_lanor2CeLPKCDp
#define sfunc sfunc_lanor2CeLPKCDp
#define unirand unirand_lanor2CeLPKCDp
...
#define Beta2 Beta2_lanor2CeLPKCDp
 double Beta2 = 0.0001;
#define Beta1 Beta1_lanor2CeLPKCDp
 double Beta1 = 0.001;
#define DA_t2 DA_t2_lanor2CeLPKCDp
 double DA_t2 = 1.4;
#define DA_t1 DA_t1_lanor2CeLPKCDp
 double DA_t1 = 1.2;
#define DAstop1 DAstop1_lanor2CeLPKCDp
 double DAstop1 = 420000;
#define DAstart1 DAstart1_lanor2CeLPKCDp
 double DAstart1 = 400000;
#define GAPstop1 GAPstop1_lanor2CeLPKCDp
 double GAPstop1 = 720000;
#define GAPstart1 GAPstart1_lanor2CeLPKCDp
 ...
 "Beta1_lanor2CeLPKCDp", "/ms",
 "Beta2_lanor2CeLPKCDp", "/ms",
 "srcid", "1",
 "destid", "1",
 "Cdur_nmda", "ms",
 "AlphaTmax_nmda", "/ms",
 ...
 "DAstart1_lanor2CeLPKCDp", &DAstart1_lanor2CeLPKCDp,
 "DAstop1_lanor2CeLPKCDp", &DAstop1_lanor2CeLPKCDp,
 "DA_t1_lanor2CeLPKCDp", &DA_t1_lanor2CeLPKCDp,
 "DA_t2_lanor2CeLPKCDp", &DA_t2_lanor2CeLPKCDp,
 "Beta1_lanor2CeLPKCDp", &Beta1_lanor2CeLPKCDp,
 "Beta2_lanor2CeLPKCDp", &Beta2_lanor2CeLPKCDp,
 "GAPstart1_lanor2CeLPKCDp", &GAPstart1_lanor2CeLPKCDp,
 "GAPstop1_lanor2CeLPKCDp", &GAPstop1_lanor2CeLPKCDp,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 lanor2CeLPKCDp /pylon5/ib560mp/latimerb/CE_Model/Scripts_NEURON/x86_64/LAnor2CeLPKCDp.mod\n");
 ...
 v=_v;
{
 ...
 for (; t < _break; t += dt) {
 error =  release();
 if(error){fprintf(stderr,"at line 163 in file LAnor2CeLPKCDp.mod:\n	\n"); nrn_complain(_p); abort_run(error);}
