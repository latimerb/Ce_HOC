...
#define DA1 DA1_banor2CeLPKCDm
#define eta eta_banor2CeLPKCDm
#define omega omega_banor2CeLPKCDm
#define sfunc sfunc_banor2CeLPKCDm
#define unirand unirand_banor2CeLPKCDm
...
#define Beta2 Beta2_banor2CeLPKCDm
 double Beta2 = 0.0001;
#define Beta1 Beta1_banor2CeLPKCDm
 double Beta1 = 0.001;
#define DA_t2 DA_t2_banor2CeLPKCDm
 double DA_t2 = 1.4;
#define DA_t1 DA_t1_banor2CeLPKCDm
 double DA_t1 = 1.2;
#define DAstop1 DAstop1_banor2CeLPKCDm
 double DAstop1 = 420000;
#define DAstart1 DAstart1_banor2CeLPKCDm
 double DAstart1 = 400000;
#define GAPstop1 GAPstop1_banor2CeLPKCDm
 double GAPstop1 = 720000;
#define GAPstart1 GAPstart1_banor2CeLPKCDm
 ...
 "Beta1_banor2CeLPKCDm", "/ms",
 "Beta2_banor2CeLPKCDm", "/ms",
 "srcid", "1",
 "destid", "1",
 "Cdur_nmda", "ms",
 "AlphaTmax_nmda", "/ms",
 ...
 "DAstart1_banor2CeLPKCDm", &DAstart1_banor2CeLPKCDm,
 "DAstop1_banor2CeLPKCDm", &DAstop1_banor2CeLPKCDm,
 "DA_t1_banor2CeLPKCDm", &DA_t1_banor2CeLPKCDm,
 "DA_t2_banor2CeLPKCDm", &DA_t2_banor2CeLPKCDm,
 "Beta1_banor2CeLPKCDm", &Beta1_banor2CeLPKCDm,
 "Beta2_banor2CeLPKCDm", &Beta2_banor2CeLPKCDm,
 "GAPstart1_banor2CeLPKCDm", &GAPstart1_banor2CeLPKCDm,
 "GAPstop1_banor2CeLPKCDm", &GAPstop1_banor2CeLPKCDm,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 banor2CeLPKCDm /pylon5/ib560mp/latimerb/CE_Model/Scripts_NEURON/x86_64/BAnor2CeLPKCDm.mod\n");
 ...
 v=_v;
{
 ...
 for (; t < _break; t += dt) {
 error =  release();
 if(error){fprintf(stderr,"at line 163 in file BAnor2CeLPKCDm.mod:\n	\n"); nrn_complain(_p); abort_run(error);}
