...
#define DA1 DA1_CeLPKCDp2CeLPKCDp
#define GAP1 GAP1_CeLPKCDp2CeLPKCDp
#define eta eta_CeLPKCDp2CeLPKCDp
#define omega omega_CeLPKCDp2CeLPKCDp
#define unirand unirand_CeLPKCDp2CeLPKCDp
...
#define Beta2 Beta2_CeLPKCDp2CeLPKCDp
 double Beta2 = 0.0001;
#define Beta1 Beta1_CeLPKCDp2CeLPKCDp
 double Beta1 = 0.001;
#define DA_S DA_S_CeLPKCDp2CeLPKCDp
 double DA_S = 1.6;
#define DA_t2 DA_t2_CeLPKCDp2CeLPKCDp
 double DA_t2 = 0.92;
#define DA_t1 DA_t1_CeLPKCDp2CeLPKCDp
 double DA_t1 = 0.97;
#define DAstop1 DAstop1_CeLPKCDp2CeLPKCDp
 double DAstop1 = 420000;
#define DAstart1 DAstart1_CeLPKCDp2CeLPKCDp
 double DAstart1 = 400000;
#define GAPstop1 GAPstop1_CeLPKCDp2CeLPKCDp
 double GAPstop1 = 720000;
#define GAPstart1 GAPstart1_CeLPKCDp2CeLPKCDp
 double GAPstart1 = 600000;
#define k k_CeLPKCDp2CeLPKCDp
 double k = 0.01;
 ...
 "Beta1_CeLPKCDp2CeLPKCDp", "/ms",
 "Beta2_CeLPKCDp2CeLPKCDp", "/ms",
 "srcid", "1",
 "destid", "1",
 "Cdur_gaba", "ms",
 "AlphaTmax_gaba", "/ms",
 ...
 "k_CeLPKCDp2CeLPKCDp", &k_CeLPKCDp2CeLPKCDp,
 "GAPstart1_CeLPKCDp2CeLPKCDp", &GAPstart1_CeLPKCDp2CeLPKCDp,
 "GAPstop1_CeLPKCDp2CeLPKCDp", &GAPstop1_CeLPKCDp2CeLPKCDp,
 "DAstart1_CeLPKCDp2CeLPKCDp", &DAstart1_CeLPKCDp2CeLPKCDp,
 "DAstop1_CeLPKCDp2CeLPKCDp", &DAstop1_CeLPKCDp2CeLPKCDp,
 "DA_t1_CeLPKCDp2CeLPKCDp", &DA_t1_CeLPKCDp2CeLPKCDp,
 "DA_t2_CeLPKCDp2CeLPKCDp", &DA_t2_CeLPKCDp2CeLPKCDp,
 "DA_S_CeLPKCDp2CeLPKCDp", &DA_S_CeLPKCDp2CeLPKCDp,
 "Beta1_CeLPKCDp2CeLPKCDp", &Beta1_CeLPKCDp2CeLPKCDp,
 "Beta2_CeLPKCDp2CeLPKCDp", &Beta2_CeLPKCDp2CeLPKCDp,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 CeLPKCDp2CeLPKCDp /pylon5/ib560mp/latimerb/CE_Model/Scripts_NEURON/x86_64/CeLPKCDp2CeLPKCDp.mod\n");
 ...
 v=_v;
{
 ...
 for (; t < _break; t += dt) {
 error =  release();
 if(error){fprintf(stderr,"at line 155 in file CeLPKCDp2CeLPKCDp.mod:\n	\n"); nrn_complain(_p); abort_run(error);}
