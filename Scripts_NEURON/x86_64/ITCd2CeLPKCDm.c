...
#define DA1 DA1_itcd2CeLPKCDm
#define GAP1 GAP1_itcd2CeLPKCDm
#define eta eta_itcd2CeLPKCDm
#define omega omega_itcd2CeLPKCDm
#define unirand unirand_itcd2CeLPKCDm
...
#define Beta2 Beta2_itcd2CeLPKCDm
 double Beta2 = 0.0001;
#define Beta1 Beta1_itcd2CeLPKCDm
 double Beta1 = 0.001;
#define DA_S DA_S_itcd2CeLPKCDm
 double DA_S = 1.6;
#define DA_t2 DA_t2_itcd2CeLPKCDm
 double DA_t2 = 0.5;
#define DA_t1 DA_t1_itcd2CeLPKCDm
 double DA_t1 = 0.7;
#define DAstop1 DAstop1_itcd2CeLPKCDm
 double DAstop1 = 420000;
#define DAstart1 DAstart1_itcd2CeLPKCDm
 double DAstart1 = 400000;
#define GAPstop1 GAPstop1_itcd2CeLPKCDm
 double GAPstop1 = 720000;
#define GAPstart1 GAPstart1_itcd2CeLPKCDm
 double GAPstart1 = 600000;
#define k k_itcd2CeLPKCDm
 double k = 0.01;
 ...
 "Beta1_itcd2CeLPKCDm", "/ms",
 "Beta2_itcd2CeLPKCDm", "/ms",
 "srcid", "1",
 "destid", "1",
 "Cdur_gaba", "ms",
 "AlphaTmax_gaba", "/ms",
 ...
 "k_itcd2CeLPKCDm", &k_itcd2CeLPKCDm,
 "GAPstart1_itcd2CeLPKCDm", &GAPstart1_itcd2CeLPKCDm,
 "GAPstop1_itcd2CeLPKCDm", &GAPstop1_itcd2CeLPKCDm,
 "DAstart1_itcd2CeLPKCDm", &DAstart1_itcd2CeLPKCDm,
 "DAstop1_itcd2CeLPKCDm", &DAstop1_itcd2CeLPKCDm,
 "DA_t1_itcd2CeLPKCDm", &DA_t1_itcd2CeLPKCDm,
 "DA_t2_itcd2CeLPKCDm", &DA_t2_itcd2CeLPKCDm,
 "DA_S_itcd2CeLPKCDm", &DA_S_itcd2CeLPKCDm,
 "Beta1_itcd2CeLPKCDm", &Beta1_itcd2CeLPKCDm,
 "Beta2_itcd2CeLPKCDm", &Beta2_itcd2CeLPKCDm,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 itcd2CeLPKCDm /pylon5/ib560mp/latimerb/CE_Model/Scripts_NEURON/x86_64/ITCd2CeLPKCDm.mod\n");
 ...
 v=_v;
{
 ...
 for (; t < _break; t += dt) {
 error =  release();
 if(error){fprintf(stderr,"at line 155 in file ITCd2CeLPKCDm.mod:\n	\n"); nrn_complain(_p); abort_run(error);}
