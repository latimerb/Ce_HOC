...
#define nrn_init _nrn_init__laer2CeLPKCDp
#define _nrn_initial _nrn_initial__laer2CeLPKCDp
#define nrn_cur _nrn_cur__laer2CeLPKCDp
#define _nrn_current _nrn_current__laer2CeLPKCDp
#define nrn_jacob _nrn_jacob__laer2CeLPKCDp
#define nrn_state _nrn_state__laer2CeLPKCDp
#define _net_receive _net_receive__laer2CeLPKCDp 
#define release release__laer2CeLPKCDp 
...
#define DA1 DA1_laer2CeLPKCDp
#define GAP1 GAP1_laer2CeLPKCDp
#define eta eta_laer2CeLPKCDp
#define omega omega_laer2CeLPKCDp
#define sfunc sfunc_laer2CeLPKCDp
#define unirand unirand_laer2CeLPKCDp
...
#define Beta2 Beta2_laer2CeLPKCDp
 double Beta2 = 0.0001;
#define Beta1 Beta1_laer2CeLPKCDp
 double Beta1 = 0.001;
#define DA_t2 DA_t2_laer2CeLPKCDp
 double DA_t2 = 1.4;
#define DA_t1 DA_t1_laer2CeLPKCDp
 double DA_t1 = 1.2;
#define DAstop1 DAstop1_laer2CeLPKCDp
 double DAstop1 = 420000;
#define DAstart1 DAstart1_laer2CeLPKCDp
 double DAstart1 = 400000;
#define GAPstop1 GAPstop1_laer2CeLPKCDp
 double GAPstop1 = 720000;
#define GAPstart1 GAPstart1_laer2CeLPKCDp
 ...
 "Beta1_laer2CeLPKCDp", "/ms",
 "Beta2_laer2CeLPKCDp", "/ms",
 "srcid", "1",
 "destid", "1",
 "Cdur_nmda", "ms",
 "AlphaTmax_nmda", "/ms",
 ...
 "DAstart1_laer2CeLPKCDp", &DAstart1_laer2CeLPKCDp,
 "DAstop1_laer2CeLPKCDp", &DAstop1_laer2CeLPKCDp,
 "DA_t1_laer2CeLPKCDp", &DA_t1_laer2CeLPKCDp,
 "DA_t2_laer2CeLPKCDp", &DA_t2_laer2CeLPKCDp,
 "Beta1_laer2CeLPKCDp", &Beta1_laer2CeLPKCDp,
 "Beta2_laer2CeLPKCDp", &Beta2_laer2CeLPKCDp,
 "GAPstart1_laer2CeLPKCDp", &GAPstart1_laer2CeLPKCDp,
 "GAPstop1_laer2CeLPKCDp", &GAPstop1_laer2CeLPKCDp,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 laer2CeLPKCDp /work/05300/latimerb/stampede2/CE_Model/Scripts_NEURON/x86_64/LAer2CeLPKCDp.mod\n");
 ...
 v=_v;
{
  eca = _ion_eca;
 { error =  release();
 if(error){fprintf(stderr,"at line 163 in file LAer2CeLPKCDp.mod:\n	\n"); nrn_complain(_p); abort_run(error);}
 }}}
