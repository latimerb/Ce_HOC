...
#define nrn_init _nrn_init__baf2CeLPKCDm
#define _nrn_initial _nrn_initial__baf2CeLPKCDm
#define nrn_cur _nrn_cur__baf2CeLPKCDm
#define _nrn_current _nrn_current__baf2CeLPKCDm
#define nrn_jacob _nrn_jacob__baf2CeLPKCDm
#define nrn_state _nrn_state__baf2CeLPKCDm
#define _net_receive _net_receive__baf2CeLPKCDm 
#define release release__baf2CeLPKCDm 
...
#define DA1 DA1_baf2CeLPKCDm
#define eta eta_baf2CeLPKCDm
#define omega omega_baf2CeLPKCDm
#define sfunc sfunc_baf2CeLPKCDm
#define unirand unirand_baf2CeLPKCDm
...
#define Beta2 Beta2_baf2CeLPKCDm
 double Beta2 = 0.0001;
#define Beta1 Beta1_baf2CeLPKCDm
 double Beta1 = 0.001;
#define DA_t2 DA_t2_baf2CeLPKCDm
 double DA_t2 = 1.4;
#define DA_t1 DA_t1_baf2CeLPKCDm
 double DA_t1 = 1.2;
#define DAstop1 DAstop1_baf2CeLPKCDm
 double DAstop1 = 420000;
#define DAstart1 DAstart1_baf2CeLPKCDm
 double DAstart1 = 400000;
#define GAPstop1 GAPstop1_baf2CeLPKCDm
 double GAPstop1 = 720000;
#define GAPstart1 GAPstart1_baf2CeLPKCDm
 ...
 "Beta1_baf2CeLPKCDm", "/ms",
 "Beta2_baf2CeLPKCDm", "/ms",
 "srcid", "1",
 "destid", "1",
 "Cdur_nmda", "ms",
 "AlphaTmax_nmda", "/ms",
 ...
 "DAstart1_baf2CeLPKCDm", &DAstart1_baf2CeLPKCDm,
 "DAstop1_baf2CeLPKCDm", &DAstop1_baf2CeLPKCDm,
 "DA_t1_baf2CeLPKCDm", &DA_t1_baf2CeLPKCDm,
 "DA_t2_baf2CeLPKCDm", &DA_t2_baf2CeLPKCDm,
 "Beta1_baf2CeLPKCDm", &Beta1_baf2CeLPKCDm,
 "Beta2_baf2CeLPKCDm", &Beta2_baf2CeLPKCDm,
 "GAPstart1_baf2CeLPKCDm", &GAPstart1_baf2CeLPKCDm,
 "GAPstop1_baf2CeLPKCDm", &GAPstop1_baf2CeLPKCDm,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 baf2CeLPKCDm /work/05300/latimerb/stampede2/CE_Model/Scripts_NEURON/x86_64/BAf2CeLPKCDm.mod\n");
 ...
 v=_v;
{
  eca = _ion_eca;
 { error =  release();
 if(error){fprintf(stderr,"at line 163 in file BAf2CeLPKCDm.mod:\n	\n"); nrn_complain(_p); abort_run(error);}
 }}}
