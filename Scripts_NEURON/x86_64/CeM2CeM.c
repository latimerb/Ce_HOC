...
#define DA1 DA1_CeM2CeM
#define GAP1 GAP1_CeM2CeM
#define eta eta_CeM2CeM
#define omega omega_CeM2CeM
#define unirand unirand_CeM2CeM
...
#define Beta2 Beta2_CeM2CeM
 double Beta2 = 0.0001;
#define Beta1 Beta1_CeM2CeM
 double Beta1 = 0.001;
#define DA_S DA_S_CeM2CeM
 double DA_S = 1.6;
#define DA_t2 DA_t2_CeM2CeM
 double DA_t2 = 0.92;
#define DA_t1 DA_t1_CeM2CeM
 double DA_t1 = 0.97;
#define DAstop1 DAstop1_CeM2CeM
 double DAstop1 = 420000;
#define DAstart1 DAstart1_CeM2CeM
 double DAstart1 = 400000;
#define GAPstop1 GAPstop1_CeM2CeM
 double GAPstop1 = 720000;
#define GAPstart1 GAPstart1_CeM2CeM
...
#define k k_CeM2CeM
 ...
 "k_CeM2CeM", &k_CeM2CeM,
 "GAPstart1_CeM2CeM", &GAPstart1_CeM2CeM,
 "GAPstop1_CeM2CeM", &GAPstop1_CeM2CeM,
 "DAstart1_CeM2CeM", &DAstart1_CeM2CeM,
 "DAstop1_CeM2CeM", &DAstop1_CeM2CeM,
 "DA_t1_CeM2CeM", &DA_t1_CeM2CeM,
 "DA_t2_CeM2CeM", &DA_t2_CeM2CeM,
 "DA_S_CeM2CeM", &DA_S_CeM2CeM,
 "Beta1_CeM2CeM", &Beta1_CeM2CeM,
 "Beta2_CeM2CeM", &Beta2_CeM2CeM,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 CeM2CeM /pylon5/ib560mp/latimerb/CE_Model/Scripts_NEURON/x86_64/CeM2CeM.mod\n");
 ...
 v=_v;
{
 ...
 for (; t < _break; t += dt) {
 error =  release();
 if(error){fprintf(stderr,"at line 155 in file CeM2CeM.mod:\n	\n"); nrn_complain(_p); abort_run(error);}
