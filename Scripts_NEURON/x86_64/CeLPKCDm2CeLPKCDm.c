...
#define nrn_init _nrn_init__CeLPKCDm2CeLPKCDm
#define _nrn_initial _nrn_initial__CeLPKCDm2CeLPKCDm
#define nrn_cur _nrn_cur__CeLPKCDm2CeLPKCDm
#define _nrn_current _nrn_current__CeLPKCDm2CeLPKCDm
#define nrn_jacob _nrn_jacob__CeLPKCDm2CeLPKCDm
#define nrn_state _nrn_state__CeLPKCDm2CeLPKCDm
#define _net_receive _net_receive__CeLPKCDm2CeLPKCDm 
#define release release__CeLPKCDm2CeLPKCDm 
...
#define DA1 DA1_CeLPKCDm2CeLPKCDm
#define GAP1 GAP1_CeLPKCDm2CeLPKCDm
#define eta eta_CeLPKCDm2CeLPKCDm
#define omega omega_CeLPKCDm2CeLPKCDm
#define unirand unirand_CeLPKCDm2CeLPKCDm
...
#define Beta2 Beta2_CeLPKCDm2CeLPKCDm
 double Beta2 = 0.0001;
#define Beta1 Beta1_CeLPKCDm2CeLPKCDm
 double Beta1 = 0.001;
#define DA_S DA_S_CeLPKCDm2CeLPKCDm
 double DA_S = 1.6;
#define DA_t2 DA_t2_CeLPKCDm2CeLPKCDm
 double DA_t2 = 0.92;
#define DA_t1 DA_t1_CeLPKCDm2CeLPKCDm
 double DA_t1 = 0.97;
#define DAstop1 DAstop1_CeLPKCDm2CeLPKCDm
 double DAstop1 = 420000;
#define DAstart1 DAstart1_CeLPKCDm2CeLPKCDm
 double DAstart1 = 400000;
#define GAPstop1 GAPstop1_CeLPKCDm2CeLPKCDm
 double GAPstop1 = 720000;
#define GAPstart1 GAPstart1_CeLPKCDm2CeLPKCDm
 double GAPstart1 = 600000;
#define k k_CeLPKCDm2CeLPKCDm
 double k = 0.01;
 ...
 "Beta1_CeLPKCDm2CeLPKCDm", "/ms",
 "Beta2_CeLPKCDm2CeLPKCDm", "/ms",
 "srcid", "1",
 "destid", "1",
 "Cdur_gaba", "ms",
 "AlphaTmax_gaba", "/ms",
 ...
 "k_CeLPKCDm2CeLPKCDm", &k_CeLPKCDm2CeLPKCDm,
 "GAPstart1_CeLPKCDm2CeLPKCDm", &GAPstart1_CeLPKCDm2CeLPKCDm,
 "GAPstop1_CeLPKCDm2CeLPKCDm", &GAPstop1_CeLPKCDm2CeLPKCDm,
 "DAstart1_CeLPKCDm2CeLPKCDm", &DAstart1_CeLPKCDm2CeLPKCDm,
 "DAstop1_CeLPKCDm2CeLPKCDm", &DAstop1_CeLPKCDm2CeLPKCDm,
 "DA_t1_CeLPKCDm2CeLPKCDm", &DA_t1_CeLPKCDm2CeLPKCDm,
 "DA_t2_CeLPKCDm2CeLPKCDm", &DA_t2_CeLPKCDm2CeLPKCDm,
 "DA_S_CeLPKCDm2CeLPKCDm", &DA_S_CeLPKCDm2CeLPKCDm,
 "Beta1_CeLPKCDm2CeLPKCDm", &Beta1_CeLPKCDm2CeLPKCDm,
 "Beta2_CeLPKCDm2CeLPKCDm", &Beta2_CeLPKCDm2CeLPKCDm,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 CeLPKCDm2CeLPKCDm /work/05300/latimerb/stampede2/CE_Model/Scripts_NEURON/x86_64/CeLPKCDm2CeLPKCDm.mod\n");
...
static double _nrn_current(double _v){double _current=0.;v=_v;{ {
   ...
   if ( neuroM  == 1.0 ) {
     g_gaba = gbar_gaba * r_gaba * facfactor * DA1 ( _threadargscomma_ DAstart1 , DAstop1 ) ;
     }
   else {
 ...
 v=_v;
{
  ...
  ica = _ion_ica;
 { error =  release();
 if(error){fprintf(stderr,"at line 155 in file CeLPKCDm2CeLPKCDm.mod:\n	\n"); nrn_complain(_p); abort_run(error);}
 }}}
