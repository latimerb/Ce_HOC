...
#define nrn_init _nrn_init__baer2CeLPKCDp
#define _nrn_initial _nrn_initial__baer2CeLPKCDp
#define nrn_cur _nrn_cur__baer2CeLPKCDp
#define _nrn_current _nrn_current__baer2CeLPKCDp
#define nrn_jacob _nrn_jacob__baer2CeLPKCDp
#define nrn_state _nrn_state__baer2CeLPKCDp
#define _net_receive _net_receive__baer2CeLPKCDp 
#define release release__baer2CeLPKCDp 
...
#define DA1 DA1_baer2CeLPKCDp
#define eta eta_baer2CeLPKCDp
#define omega omega_baer2CeLPKCDp
#define sfunc sfunc_baer2CeLPKCDp
#define unirand unirand_baer2CeLPKCDp
...
#define Beta2 Beta2_baer2CeLPKCDp
 double Beta2 = 0.0001;
#define Beta1 Beta1_baer2CeLPKCDp
 double Beta1 = 0.001;
#define DA_t2 DA_t2_baer2CeLPKCDp
 double DA_t2 = 1.4;
#define DA_t1 DA_t1_baer2CeLPKCDp
 double DA_t1 = 1.2;
#define DAstop1 DAstop1_baer2CeLPKCDp
 double DAstop1 = 420000;
#define DAstart1 DAstart1_baer2CeLPKCDp
 double DAstart1 = 400000;
#define GAPstop1 GAPstop1_baer2CeLPKCDp
 double GAPstop1 = 720000;
#define GAPstart1 GAPstart1_baer2CeLPKCDp
 ...
 "Beta1_baer2CeLPKCDp", "/ms",
 "Beta2_baer2CeLPKCDp", "/ms",
 "srcid", "1",
 "destid", "1",
 "Cdur_nmda", "ms",
 "AlphaTmax_nmda", "/ms",
 ...
 "DAstart1_baer2CeLPKCDp", &DAstart1_baer2CeLPKCDp,
 "DAstop1_baer2CeLPKCDp", &DAstop1_baer2CeLPKCDp,
 "DA_t1_baer2CeLPKCDp", &DA_t1_baer2CeLPKCDp,
 "DA_t2_baer2CeLPKCDp", &DA_t2_baer2CeLPKCDp,
 "Beta1_baer2CeLPKCDp", &Beta1_baer2CeLPKCDp,
 "Beta2_baer2CeLPKCDp", &Beta2_baer2CeLPKCDp,
 "GAPstart1_baer2CeLPKCDp", &GAPstart1_baer2CeLPKCDp,
 "GAPstop1_baer2CeLPKCDp", &GAPstop1_baer2CeLPKCDp,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 baer2CeLPKCDp /work/05300/latimerb/stampede2/CE_Model/Scripts_NEURON/x86_64/BAer2CeLPKCDp.mod\n");
 ...
 v=_v;
{
  eca = _ion_eca;
 { error =  release();
 if(error){fprintf(stderr,"at line 163 in file BAer2CeLPKCDp.mod:\n	\n"); nrn_complain(_p); abort_run(error);}
 }}}
