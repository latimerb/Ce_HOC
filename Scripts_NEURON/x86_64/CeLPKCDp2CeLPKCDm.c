...
#define nrn_init _nrn_init__CeLPKCDp2CeLPKCDm
#define _nrn_initial _nrn_initial__CeLPKCDp2CeLPKCDm
#define nrn_cur _nrn_cur__CeLPKCDp2CeLPKCDm
#define _nrn_current _nrn_current__CeLPKCDp2CeLPKCDm
#define nrn_jacob _nrn_jacob__CeLPKCDp2CeLPKCDm
#define nrn_state _nrn_state__CeLPKCDp2CeLPKCDm
#define _net_receive _net_receive__CeLPKCDp2CeLPKCDm 
#define release release__CeLPKCDp2CeLPKCDm 
...
#define DA1 DA1_CeLPKCDp2CeLPKCDm
#define GAP1 GAP1_CeLPKCDp2CeLPKCDm
#define eta eta_CeLPKCDp2CeLPKCDm
#define omega omega_CeLPKCDp2CeLPKCDm
#define unirand unirand_CeLPKCDp2CeLPKCDm
...
#define Beta2 Beta2_CeLPKCDp2CeLPKCDm
 double Beta2 = 0.0001;
#define Beta1 Beta1_CeLPKCDp2CeLPKCDm
 double Beta1 = 0.001;
#define DA_S DA_S_CeLPKCDp2CeLPKCDm
 double DA_S = 1.6;
#define DA_t2 DA_t2_CeLPKCDp2CeLPKCDm
 double DA_t2 = 0.92;
#define DA_t1 DA_t1_CeLPKCDp2CeLPKCDm
 double DA_t1 = 0.97;
#define DAstop1 DAstop1_CeLPKCDp2CeLPKCDm
 double DAstop1 = 420000;
#define DAstart1 DAstart1_CeLPKCDp2CeLPKCDm
 double DAstart1 = 400000;
#define GAPstop1 GAPstop1_CeLPKCDp2CeLPKCDm
 double GAPstop1 = 720000;
#define GAPstart1 GAPstart1_CeLPKCDp2CeLPKCDm
 double GAPstart1 = 600000;
#define k k_CeLPKCDp2CeLPKCDm
 double k = 0.01;
 ...
 "Beta1_CeLPKCDp2CeLPKCDm", "/ms",
 "Beta2_CeLPKCDp2CeLPKCDm", "/ms",
 "srcid", "1",
 "destid", "1",
 "Cdur_gaba", "ms",
 "AlphaTmax_gaba", "/ms",
 ...
 "k_CeLPKCDp2CeLPKCDm", &k_CeLPKCDp2CeLPKCDm,
 "GAPstart1_CeLPKCDp2CeLPKCDm", &GAPstart1_CeLPKCDp2CeLPKCDm,
 "GAPstop1_CeLPKCDp2CeLPKCDm", &GAPstop1_CeLPKCDp2CeLPKCDm,
 "DAstart1_CeLPKCDp2CeLPKCDm", &DAstart1_CeLPKCDp2CeLPKCDm,
 "DAstop1_CeLPKCDp2CeLPKCDm", &DAstop1_CeLPKCDp2CeLPKCDm,
 "DA_t1_CeLPKCDp2CeLPKCDm", &DA_t1_CeLPKCDp2CeLPKCDm,
 "DA_t2_CeLPKCDp2CeLPKCDm", &DA_t2_CeLPKCDp2CeLPKCDm,
 "DA_S_CeLPKCDp2CeLPKCDm", &DA_S_CeLPKCDp2CeLPKCDm,
 "Beta1_CeLPKCDp2CeLPKCDm", &Beta1_CeLPKCDp2CeLPKCDm,
 "Beta2_CeLPKCDp2CeLPKCDm", &Beta2_CeLPKCDp2CeLPKCDm,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 CeLPKCDp2CeLPKCDm /work/05300/latimerb/stampede2/CE_Model/Scripts_NEURON/x86_64/CeLPKCDp2CeLPKCDm.mod\n");
 ...
 v=_v;
{
  ...
  ica = _ion_ica;
 { error =  release();
 if(error){fprintf(stderr,"at line 155 in file CeLPKCDp2CeLPKCDm.mod:\n	\n"); nrn_complain(_p); abort_run(error);}
 }}}
