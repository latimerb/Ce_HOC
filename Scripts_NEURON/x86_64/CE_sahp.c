...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 sAHP /work/05300/latimerb/stampede2/CE_Model/Scripts_NEURON/x86_64/CE_sahp.mod\n");
...
static int  rate ( _threadargsprotocomma_ double _lv , double _lcai ) {
  ...
  _lca = 0.0048 / ( exp ( - 5.0 * log10 ( 1e3 * _lcai ) + 17.5 ) ) ;
   _lcb = 0.012 / ( exp ( 2.0 * log10 ( 1e3 * _lcai ) + 20.0 ) ) ;
   _lcsum = _lca + _lcb ;
   cinf = _lca / _lcsum ;
   ctau = 48.0 ;
     return 0; }
