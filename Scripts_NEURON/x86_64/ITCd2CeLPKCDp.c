...
#define nrn_init _nrn_init__itcd2CeLPKCDp
#define _nrn_initial _nrn_initial__itcd2CeLPKCDp
#define nrn_cur _nrn_cur__itcd2CeLPKCDp
#define _nrn_current _nrn_current__itcd2CeLPKCDp
#define nrn_jacob _nrn_jacob__itcd2CeLPKCDp
#define nrn_state _nrn_state__itcd2CeLPKCDp
#define _net_receive _net_receive__itcd2CeLPKCDp 
#define release release__itcd2CeLPKCDp 
...
#define DA1 DA1_itcd2CeLPKCDp
#define GAP1 GAP1_itcd2CeLPKCDp
#define eta eta_itcd2CeLPKCDp
#define omega omega_itcd2CeLPKCDp
#define unirand unirand_itcd2CeLPKCDp
...
#define Beta2 Beta2_itcd2CeLPKCDp
 double Beta2 = 0.0001;
#define Beta1 Beta1_itcd2CeLPKCDp
 double Beta1 = 0.001;
#define DA_S DA_S_itcd2CeLPKCDp
 double DA_S = 1.6;
#define DA_t2 DA_t2_itcd2CeLPKCDp
 double DA_t2 = 0.5;
#define DA_t1 DA_t1_itcd2CeLPKCDp
 double DA_t1 = 0.7;
#define DAstop1 DAstop1_itcd2CeLPKCDp
 double DAstop1 = 420000;
#define DAstart1 DAstart1_itcd2CeLPKCDp
 double DAstart1 = 400000;
#define GAPstop1 GAPstop1_itcd2CeLPKCDp
 double GAPstop1 = 720000;
#define GAPstart1 GAPstart1_itcd2CeLPKCDp
 double GAPstart1 = 600000;
#define k k_itcd2CeLPKCDp
 double k = 0.01;
 ...
 "Beta1_itcd2CeLPKCDp", "/ms",
 "Beta2_itcd2CeLPKCDp", "/ms",
 "srcid", "1",
 "destid", "1",
 "Cdur_gaba", "ms",
 "AlphaTmax_gaba", "/ms",
 ...
 "k_itcd2CeLPKCDp", &k_itcd2CeLPKCDp,
 "GAPstart1_itcd2CeLPKCDp", &GAPstart1_itcd2CeLPKCDp,
 "GAPstop1_itcd2CeLPKCDp", &GAPstop1_itcd2CeLPKCDp,
 "DAstart1_itcd2CeLPKCDp", &DAstart1_itcd2CeLPKCDp,
 "DAstop1_itcd2CeLPKCDp", &DAstop1_itcd2CeLPKCDp,
 "DA_t1_itcd2CeLPKCDp", &DA_t1_itcd2CeLPKCDp,
 "DA_t2_itcd2CeLPKCDp", &DA_t2_itcd2CeLPKCDp,
 "DA_S_itcd2CeLPKCDp", &DA_S_itcd2CeLPKCDp,
 "Beta1_itcd2CeLPKCDp", &Beta1_itcd2CeLPKCDp,
 "Beta2_itcd2CeLPKCDp", &Beta2_itcd2CeLPKCDp,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 itcd2CeLPKCDp /work/05300/latimerb/stampede2/CE_Model/Scripts_NEURON/x86_64/ITCd2CeLPKCDp.mod\n");
 ...
 v=_v;
{
  ...
  ica = _ion_ica;
 { error =  release();
 if(error){fprintf(stderr,"at line 155 in file ITCd2CeLPKCDp.mod:\n	\n"); nrn_complain(_p); abort_run(error);}
 }}}
