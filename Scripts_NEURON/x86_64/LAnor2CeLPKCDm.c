...
#define DA1 DA1_lanor2CeLPKCDm
#define GAP1 GAP1_lanor2CeLPKCDm
#define eta eta_lanor2CeLPKCDm
#define omega omega_lanor2CeLPKCDm
#define sfunc sfunc_lanor2CeLPKCDm
#define unirand unirand_lanor2CeLPKCDm
...
#define Beta2 Beta2_lanor2CeLPKCDm
 double Beta2 = 0.0001;
#define Beta1 Beta1_lanor2CeLPKCDm
 double Beta1 = 0.001;
#define DA_t2 DA_t2_lanor2CeLPKCDm
 double DA_t2 = 1.4;
#define DA_t1 DA_t1_lanor2CeLPKCDm
 double DA_t1 = 1.2;
#define DAstop1 DAstop1_lanor2CeLPKCDm
 double DAstop1 = 420000;
#define DAstart1 DAstart1_lanor2CeLPKCDm
 double DAstart1 = 400000;
#define GAPstop1 GAPstop1_lanor2CeLPKCDm
 double GAPstop1 = 720000;
#define GAPstart1 GAPstart1_lanor2CeLPKCDm
 ...
 "Beta1_lanor2CeLPKCDm", "/ms",
 "Beta2_lanor2CeLPKCDm", "/ms",
 "srcid", "1",
 "destid", "1",
 "Cdur_nmda", "ms",
 "AlphaTmax_nmda", "/ms",
 ...
 "DAstart1_lanor2CeLPKCDm", &DAstart1_lanor2CeLPKCDm,
 "DAstop1_lanor2CeLPKCDm", &DAstop1_lanor2CeLPKCDm,
 "DA_t1_lanor2CeLPKCDm", &DA_t1_lanor2CeLPKCDm,
 "DA_t2_lanor2CeLPKCDm", &DA_t2_lanor2CeLPKCDm,
 "Beta1_lanor2CeLPKCDm", &Beta1_lanor2CeLPKCDm,
 "Beta2_lanor2CeLPKCDm", &Beta2_lanor2CeLPKCDm,
 "GAPstart1_lanor2CeLPKCDm", &GAPstart1_lanor2CeLPKCDm,
 "GAPstop1_lanor2CeLPKCDm", &GAPstop1_lanor2CeLPKCDm,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 lanor2CeLPKCDm /pylon5/ib560mp/latimerb/CE_Model/Scripts_NEURON/x86_64/LAnor2CeLPKCDm.mod\n");
 ...
 v=_v;
{
 ...
 for (; t < _break; t += dt) {
 error =  release();
 if(error){fprintf(stderr,"at line 163 in file LAnor2CeLPKCDm.mod:\n	\n"); nrn_complain(_p); abort_run(error);}
